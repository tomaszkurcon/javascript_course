  ...
  <body>
    ...
    case "POST /": {
      ...
      request.on("end", () => {
        ...
        /* ************************************************** */
        // Place given data (here: 'Hello <name>') in the body of the answer
        response.write(`Hello ${data}`); // "url.searchParams.get('name')" contains the contents of the field (form) named 'name'
        /* ************************************************** */
        response.end(); // The end of the response — send it to the browser
      });
...
//Nie działa jak typowy server WWW bo nie ma zaimplemenej obsługi requestów dla danych plików
